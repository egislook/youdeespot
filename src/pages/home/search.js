...
const ElemPlaylistPreview = ({ img, title, channelTitle, playlistId }) => (
  <Link key={title} className="mdx-m:4px md-m:10px" to={'/playlist/' + playlistId }>
    <span className="mdx-w:200px lg-w:225px bg:26292D bs:2 br:5px w:100pc m-b:20px hv-scl:1.05_bg:black ts:all">
